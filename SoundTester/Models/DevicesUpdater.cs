...
namespace SoundTesting
{
        ...
        DevicesUpdater : IMMNotificationClient //Кастомный интерфейс уведомлений об изменении количества и состояния подключенных аудиоустройств
    {
        ...
        {
            //var inD = DirectSoundOut.Devices;
            // var outD = DirectSoundCapture.Devices;
        ...
        public void
            OnDefaultDeviceChanged(DataFlow flow, Role role, string defaultDeviceId) //Изменение устройства по-умолчанию
        {
            DeviceListUpdate();
        }
